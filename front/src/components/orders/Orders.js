...
export default function Orders() {
  ...
  const deleteOrder = useDeleteFetch(
    "orders",
    orderId,
    getAllOrders,
  ...
  const recordOrder = useAccRejFetch(
    "PUT",
    "orders",
    "active-order",
    orderId,
  ...
  const rejectOrder = useAccRejFetch(
    "PUT",
    "orders",
    "active-order",
    orderId,
  ...
  return (
    <>
      {isAdminLogin ? ( <div className="orders-div">
