...
export default function Offers() {
  ...
  const deleteOff = useDeleteFetch(
    "offs",
    offId,
    getAllOffers,
  ...
  const acceptOff = useAccRejFetch(
    "PUT",
    "offs",
    "active-off",
    offId,
  ...
  const rejectOff = useAccRejFetch(
    "PUT",
    "offs",
    "active-off",
    offId,
